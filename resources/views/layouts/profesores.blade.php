		...
		<div class="row">
			<div class="col-lg-10 col-12 mx-auto">
				...
				<div class="tab-content">
					<div class="tab-pane fade show active" id="instructor-1">
						<div class="row">
							<div class="instructor-details text-left col-lg-7 col-12">
								<h4 class="instructor-name">eloy regalado leyva</h4>
					...
					<div class="tab-pane fade show" id="instructor-2">
						<div class="row">
							<div class="instructor-details text-left col-lg-7 col-12">
								<h4 class="instructor-name">eloy regalado leyva</h4>
								<h5 class="instructor-title">Clases teóricas y prácticas</h5>
				...
				<ul class="instructor-tab-list fix">
					<li><a href="#instructor-1" data-toggle="tab"><img src="img/instructor/1.jpg" alt="" /></a></li>
