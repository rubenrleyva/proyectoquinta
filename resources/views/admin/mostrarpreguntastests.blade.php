            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="dataTables_wrapper dt-bootstrap4">
                        <a class="btn color wow fadeInLeft mb-10" href="{{ route('admin.crearpreguntatest', $test->id) }}">Crear pregunta</a>
                        <div class="row">
                                    ...
                                    <tbody>
                                        @foreach ($preguntas as $pregunta)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.editarpreguntatest.editar', $pregunta->id ) }}" class="btn color wow fadeInLeft mb-10"><i class="icofont icofont-edit-alt"></i></a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('admin.borrarpreguntatest.borrar', ['pregunta'=>$pregunta->id]) }}" method="POST" style="display: inline" onclick="return confirm('¿Quieres borrar la pregunta?')" >
                                                        @csrf
                                                        @method('DELETE')
